...
public class CustomerDaoImpl implements CustomerDao {
    ...
    public int Delete(Customer customer) {
        ...
        try {
            ...
            String updateOrdersQuery = "UPDATE [Shipper1].[dbo].[ORDERS] SET CUS_ID = NULL WHERE CUS_ID = ?";
            ...
            String deleteCustomerQuery = "DELETE FROM [Shipper1].[dbo].[CUSTOMER] WHERE CUS_ID = ?";
	...
	public int getDataFromCusPhone(String phoneNumber, Customer customer) {
		...
		try {
			...
			String sql = "SELECT  [CUS_ID]\r\n"
					...
					+ "      ,[CUS_WARD]\r\n"
					+ "      ,[CUS_PROVINCE]\r\n"
					+ "      ,[CUS_DISTRICT] FROM [Shipper1].[dbo].[CUSTOMER] WHERE [CUS_PHONENUMBER] = ?";
			PreparedStatement ps = conn.prepareStatement(sql);
