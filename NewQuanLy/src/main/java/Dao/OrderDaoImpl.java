...
public class OrderDaoImpl implements OrderDao {
	...
	public List<Order> getDeliveryOrders() {
		try {
			...
			String sql = "SELECT * FROM [ORDERS] WHERE ORD_TIME IS NOT NULL AND ORD_COMPLETED_TIME IS NULL ;";
			PreparedStatement ps = conn.prepareStatement(sql);
	...
	public int checkPhoneNumberExists(String phoneNumber, Customer customer) {
		try {
			...
			if (rs.next()) {
				...
				System.out.println(rs.getString("CUS_PROVINCE") + "_" + rs.getString("CUS_DISTRICT") + "_"
						+ rs.getString("CUS_WARD"));
