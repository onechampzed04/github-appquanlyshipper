...
//  JFrame update and delete
	...
	public void selectService() {
		System.out.println(
				" " + jcbWard.getSelectedItem() + jcbDistinct.getSelectedItem() + jcbProvince.getSelectedItem());
			...
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					if (optionservice != null && jtfWeight.getText() != null && !jtfWeight.getText().isEmpty()
						...
						jlbShipFee.setText("" + servicecheck.getPrice() * Double.parseDouble(jlbDistance.getText()));
						servicecheck = null;
					}
				}
			}
